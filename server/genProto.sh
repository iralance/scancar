function genProto {
    ...
    protoc -I=$PROTO_PATH --go_out=$GO_OUT_PATH --go_opt=paths=source_relative --go-grpc_out=$GO_OUT_PATH --go-grpc_opt=paths=source_relative --grpc-gateway_out=$GO_OUT_PATH --grpc-gateway_opt paths=source_relative ${DOMAIN}.proto
